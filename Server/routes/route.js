...
const {getDetails,getRole,getHistory,addWorker,getComments,addComments,getJobs,addJob,addComplete,addRatings,getWorker,nearWorker}=require('../Controllers/getDetails.js')
...
router.route('/role/near/:location').get(ensure, nearWorker)
